    ...
    module2.exports = {
      listTags: (prefix, fallbackToNoPrefixSearch2) => {
        ...
        try {
          ...
          core2.startGroup('Found Repository Tags');
          core2.info(`The following tags were found:
${tags}
`);
          core2.endGroup();
          return tags.split('\n').map(t => t.trim());
  ...
  'src/version.js'(exports2, module2) {
    ...
    function determineReleaseTypeFromGitLog(baseCommit, finalCommit) {
      ...
      for (let i = 0; i < commitObjects.length; i++) {
        ...
        core2.info(`--------------------------------------------------------------------------`);
        core2.startGroup(`Examine commit ${commitObj.abbreviatedCommitHash}`);
        core2.info(`RAW BODY: "${body}"`);
        core2.info(`
COMMIT NOTES: "${notes}"`);
